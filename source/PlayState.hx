...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// Add Arda Engine watermark
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " - " + CoolUtil.difficultyFromInt(storyDifficulty) + (Main.watermarks ? " | AE " + MainMenuState.ardaEngineVer : ""), 16);
